...
class QScriptEngine(PySide2.QtCore.QObject):
    ...
    @overload
    def __init__(self, parent: typing.Union[PySide2.QtCore.QObject,None], destroyed: typing.Callable = ..., objectName: str = ..., objectNameChanged: typing.Callable = ..., signalHandlerException: typing.Callable = ...) -> None: ...
