...
class QAbstractItemModelReplica(PySide2.QtCore.QAbstractItemModel):
    initialized: ClassVar[PySide2.QtCore.Signal] = ...
...
class QRemoteObjectAbstractPersistedStore(PySide2.QtCore.QObject):
    ...
    def saveProperties(self, repName: str, repSig: typing.Union[PySide2.QtCore.QByteArray,bytes], values: typing.Sequence[typing.Any]) -> None: ...

class QRemoteObjectDynamicReplica(QRemoteObjectReplica):
    initialized: ClassVar[PySide2.QtCore.Signal] = ...
    notified: ClassVar[PySide2.QtCore.Signal] = ...
...
class QRemoteObjectHostBase(QRemoteObjectNode):
    class AllowedSchemas:
        AllowExternalRegistration: ClassVar[QRemoteObjectHostBase.AllowedSchemas] = ...
        BuiltInSchemasOnly: ClassVar[QRemoteObjectHostBase.AllowedSchemas] = ...
...
class QRemoteObjectNode(PySide2.QtCore.QObject):
    class ErrorCode:
        HostUrlInvalid: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        ListenFailed: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        MissingObjectName: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        NoError: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        NodeIsNoServer: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        OperationNotValidOnClientNode: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        ProtocolMismatch: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        RegistryAlreadyHosted: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        RegistryNotAcquired: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        ServerAlreadyCreated: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        SourceNotRegistered: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        UnintendedRegistryHosting: ClassVar[QRemoteObjectNode.ErrorCode] = ...
        values: ClassVar[dict] = ...
        name: Any
        @classmethod
        def __init__(cls, *args, **kwargs) -> None: ...
    ...
    heartbeatIntervalChanged: ClassVar[PySide2.QtCore.Signal] = ...
    remoteObjectAdded: ClassVar[PySide2.QtCore.Signal] = ...
    remoteObjectRemoved: ClassVar[PySide2.QtCore.Signal] = ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    @overload
...
class QRemoteObjectPendingCall(shiboken2.Object):
    class Error:
        InvalidMessage: ClassVar[QRemoteObjectPendingCall.Error] = ...
        NoError: ClassVar[QRemoteObjectPendingCall.Error] = ...
        values: ClassVar[dict] = ...
        name: Any
        @classmethod
        def __init__(cls, *args, **kwargs) -> None: ...
...
class QRemoteObjectReplica(PySide2.QtCore.QObject):
    class State:
        Default: ClassVar[QRemoteObjectReplica.State] = ...
        SignatureMismatch: ClassVar[QRemoteObjectReplica.State] = ...
        Suspect: ClassVar[QRemoteObjectReplica.State] = ...
        Uninitialized: ClassVar[QRemoteObjectReplica.State] = ...
        Valid: ClassVar[QRemoteObjectReplica.State] = ...
        values: ClassVar[dict] = ...
        name: Any
        @classmethod
        def __init__(cls, *args, **kwargs) -> None: ...
    ...
    def persistProperties(self, repName: str, repSig: typing.Union[PySide2.QtCore.QByteArray,bytes], props: typing.Sequence[typing.Any]) -> None: ...
    ...
    def send(self, call: PySide2.QtCore.QMetaObject.Call, index: int, args: typing.Sequence[typing.Any]) -> None: ...
    def sendWithReply(self, call: PySide2.QtCore.QMetaObject.Call, index: int, args: typing.Sequence[typing.Any]) -> QRemoteObjectPendingCall: ...
    def setChild(self, i: int, arg__2: typing.Any) -> None: ...
    def setNode(self, node: QRemoteObjectNode) -> None: ...
    def setProperties(self, arg__1: typing.Sequence[typing.Any]) -> None: ...
