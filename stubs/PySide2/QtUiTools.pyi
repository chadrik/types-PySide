...
class QUiLoader(PySide2.QtCore.QObject):
    ...
    def createAction(self, parent: typing.Union[PySide2.QtCore.QObject,None] = ..., name: str = ...) -> PySide2.QtWidgets.QAction: ...
    def createActionGroup(self, parent: typing.Union[PySide2.QtCore.QObject,None] = ..., name: str = ...) -> PySide2.QtWidgets.QActionGroup: ...
    def createLayout(self, className: str, parent: typing.Union[PySide2.QtCore.QObject,None] = ..., name: str = ...) -> PySide2.QtWidgets.QLayout: ...
    def createWidget(self, className: str, parent: typing.Union[PySide2.QtWidgets.QWidget,None] = ..., name: str = ...) -> PySide2.QtWidgets.QWidget: ...
    def errorString(self) -> str: ...
    def isLanguageChangeEnabled(self) -> bool: ...
    def isTranslationEnabled(self) -> bool: ...
    @overload
    def load(self, arg__1: str, parentWidget: typing.Union[PySide2.QtWidgets.QWidget,None] = ...) -> PySide2.QtWidgets.QWidget: ...
    @overload
    def load(self, device: PySide2.QtCore.QIODevice, parentWidget: typing.Union[PySide2.QtWidgets.QWidget,None] = ...) -> PySide2.QtWidgets.QWidget: ...
