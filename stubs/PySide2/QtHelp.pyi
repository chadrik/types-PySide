...
class QHelpContentModel(PySide2.QtCore.QAbstractItemModel):
    contentsCreated: ClassVar[PySide2.QtCore.Signal] = ...
    contentsCreationStarted: ClassVar[PySide2.QtCore.Signal] = ...
...
class QHelpEngineCore(PySide2.QtCore.QObject):
    currentFilterChanged: ClassVar[PySide2.QtCore.Signal] = ...
    readersAboutToBeInvalidated: ClassVar[PySide2.QtCore.Signal] = ...
    setupFinished: ClassVar[PySide2.QtCore.Signal] = ...
    setupStarted: ClassVar[PySide2.QtCore.Signal] = ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    warning: ClassVar[PySide2.QtCore.Signal] = ...
    def __init__(self, collectionFile: str, parent: typing.Union[PySide2.QtCore.QObject,None] = ..., destroyed: typing.Callable = ..., objectName: str = ..., objectNameChanged: typing.Callable = ...) -> None: ...
    ...
    @overload
    def files(self, namespaceName: str, filterAttributes: typing.Sequence[str], extensionFilter: str = ...) -> typing.List[PySide2.QtCore.QUrl]: ...
    @overload
...
class QHelpFilterData(shiboken2.Object):
    ...
    def setVersions(self, versions: typing.Sequence[PySide2.QtCore.QVersionNumber]) -> None: ...
...
class QHelpFilterEngine(PySide2.QtCore.QObject):
    filterActivated: ClassVar[PySide2.QtCore.Signal] = ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
...
class QHelpFilterSettingsWidget(PySide2.QtWidgets.QWidget):
    ...
    def setAvailableVersions(self, versions: typing.Sequence[PySide2.QtCore.QVersionNumber]) -> None: ...

class QHelpIndexModel(PySide2.QtCore.QStringListModel):
    indexCreated: ClassVar[PySide2.QtCore.Signal] = ...
    indexCreationStarted: ClassVar[PySide2.QtCore.Signal] = ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    @overload
...
class QHelpIndexWidget(PySide2.QtWidgets.QListView):
    documentActivated: ClassVar[PySide2.QtCore.Signal] = ...
    documentsActivated: ClassVar[PySide2.QtCore.Signal] = ...
    linkActivated: ClassVar[PySide2.QtCore.Signal] = ...
    linksActivated: ClassVar[PySide2.QtCore.Signal] = ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
...
class QHelpSearchEngine(PySide2.QtCore.QObject):
    indexingFinished: ClassVar[PySide2.QtCore.Signal] = ...
    indexingStarted: ClassVar[PySide2.QtCore.Signal] = ...
    searchingFinished: ClassVar[PySide2.QtCore.Signal] = ...
    searchingStarted: ClassVar[PySide2.QtCore.Signal] = ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
...
class QHelpSearchQuery(shiboken2.Object):
    class FieldName:
        ALL: ClassVar[QHelpSearchQuery.FieldName] = ...
        ATLEAST: ClassVar[QHelpSearchQuery.FieldName] = ...
        DEFAULT: ClassVar[QHelpSearchQuery.FieldName] = ...
        FUZZY: ClassVar[QHelpSearchQuery.FieldName] = ...
        PHRASE: ClassVar[QHelpSearchQuery.FieldName] = ...
        WITHOUT: ClassVar[QHelpSearchQuery.FieldName] = ...
    ...
    @overload
    def __init__(self, field: QHelpSearchQuery.FieldName, wordList_: typing.Sequence[str]) -> None: ...
    def __copy__(self) -> None: ...

class QHelpSearchQueryWidget(PySide2.QtWidgets.QWidget):
    search: ClassVar[PySide2.QtCore.Signal] = ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
...
class QHelpSearchResultWidget(PySide2.QtWidgets.QWidget):
    requestShowLink: ClassVar[PySide2.QtCore.Signal] = ...
    staticMetaObject: ClassVar[PySide2.QtCore.QMetaObject] = ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def changeEvent(self, event: PySide2.QtCore.QEvent) -> None: ...
