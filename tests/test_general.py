...
def test_qcoreapplication():
    ...
    s = QtCore.QCoreApplication.translate("GitFlowAdvanceIntBranch", "hidden", "some help")
...
def test_qicon():
    icon = QtGui.QIcon()
    icon.addPixmap(
        QtGui.QPixmap(":/img/multigit-logo-256.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off
    )
...
def test_qmessagebox():
    ...
    multiple_buttons = QtWidgets.QMessageBox.StandardButton.Ok | QtWidgets.QMessageBox.StandardButton.Ok
    ...
    multiple_buttons = QtWidgets.QMessageBox.StandardButtons(QtWidgets.QMessageBox.StandardButton.Ok)
    multiple_buttons = QtWidgets.QMessageBox.StandardButtons(
    ...
    one_button = QtWidgets.QMessageBox.StandardButton(QtWidgets.QMessageBox.StandardButton.Ok)
...
def test_qpainter():
    ...
    painter.drawLines(
        [
            QtCore.QLine(0, 1, 2, 3),
            QtCore.QLine(1, 2, 3, 4),
            QtCore.QLine(2, 3, 4, 5)
        ]
    )
    painter.drawPoints(
        [
